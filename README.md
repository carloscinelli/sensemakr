...
[![R-CMD-check](https://github.com/carloscinelli/sensemakr/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/carloscinelli/sensemakr/actions/workflows/R-CMD-check.yaml)
[![Codecov test
coverage](https://codecov.io/gh/carloscinelli/sensemakr/graph/badge.svg)](https://app.codecov.io/gh/carloscinelli/sensemakr)
<!-- badges: end -->
