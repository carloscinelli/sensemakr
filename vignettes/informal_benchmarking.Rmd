...
As explained in Section 6.1 of [Cinelli and Hazlett (2020)](https://doi.org/10.1111/rssb.12348), there are two problems affecting informal benchmarks in this setting. First, we have to make an adjustment of baseline variance to be explained, since the sensitivity parameters consider the partial $R^2$ of $Z$ with the outcome, after taking into account what is already explained by $X$. Second, note that, although $Z$ is ideed independent of $X$, $Z$ is not independent of $X$ *given* $D$, because $D$ is a collider (Pearl, 2009). This distorts the observed quantities of $X$ that are being used for benchmarking.
